...
texts_features = layers.Embedding(size_vocabulary, 3, name = "text")(texts_features)
...
```
![BP3_combined_diagram.png]({{ site.baseurl }}/images/BP3_title_diagram.png)
...
First, get the weights for both title and text:
...
Next, define a function to return the figure of the embedding plot. The input is the
