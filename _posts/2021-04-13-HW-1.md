...
** Remark: the .html file is not shown correctly on the computer so that I was not able to transfer it yet, but the function successfully execute. Problem might be solved with updating several external packages to PIC16B environment.
